...
extension Holding {
    ...
    static var wege3: Holding {
        Holding(ticker: "WEGE3", displayName: "WEG ON", quantity: 200, averagePrice: 35.00, currentPrice: 42.00, dividendYield: 1.2, assetClass: .acoesBR, status: .congelar, targetPercent: 5)
    }
    ...
    static var taee11: Holding {
        Holding(ticker: "TAEE11", displayName: "Taesa Unit", quantity: 150, averagePrice: 34.00, currentPrice: 38.50, dividendYield: 9.0, assetClass: .acoesBR, status: .congelar, targetPercent: 4)
    }
    static var lren3: Holding {
        Holding(ticker: "LREN3", displayName: "Lojas Renner ON", quantity: 100, averagePrice: 22.00, currentPrice: 16.50, dividendYield: 2.5, assetClass: .acoesBR, status: .quarentena, targetPercent: 3)
    }
    ...
    static var mxrf11: Holding {
        Holding(ticker: "MXRF11", displayName: "Maxi Renda FII", quantity: 500, averagePrice: 10.20, currentPrice: 10.50, dividendYield: 11.0, assetClass: .fiis, status: .congelar, targetPercent: 3)
    }
    ...
    static var nvda: Holding {
        Holding(ticker: "NVDA", displayName: "NVIDIA Corp", quantity: 30, averagePrice: 200, currentPrice: 880, dividendYield: 0.03, assetClass: .usStocks, currency: .usd, status: .congelar, targetPercent: 6)
    }
    ...
    static var btc: Holding {
        Holding(ticker: "BTC", displayName: "Bitcoin", quantity: 0.5, averagePrice: 40_000, currentPrice: 67_000, dividendYield: 0, assetClass: .crypto, currency: .usd, status: .congelar, targetPercent: 5)
    }
