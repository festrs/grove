...
func seedTestData(_ ctx: ModelContext) -> (portfolio: Portfolio, holdings: [Holding]) {
    ...
    let h4 = Holding(ticker: "WEGE3.SA", displayName: "WEG", quantity: 50, averagePrice: 35, currentPrice: 40, dividendYield: Decimal(string: "1.2")!, assetClass: .acoesBR, status: .estudo, targetPercent: 5)
