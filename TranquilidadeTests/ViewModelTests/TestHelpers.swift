...
func seedTestData(_ ctx: ModelContext) -> (portfolio: Portfolio, holdings: [Holding]) {
    ...
    let h1 = Holding(ticker: "ITUB3.SA", displayName: "Itau", quantity: 100, averagePrice: 28, currentPrice: 32, dividendYield: 6, assetClass: .acoesBR, status: .aportar, targetPercent: 5)
    let h2 = Holding(ticker: "BTLG11.SA", displayName: "BTG Logistica", quantity: 50, averagePrice: 95, currentPrice: 100, dividendYield: 8, assetClass: .fiis, status: .aportar, targetPercent: 5)
    ...
    let h4 = Holding(ticker: "WEGE3.SA", displayName: "WEG", quantity: 50, averagePrice: 35, currentPrice: 40, dividendYield: Decimal(string: "1.2")!, assetClass: .acoesBR, status: .congelar, targetPercent: 5)
